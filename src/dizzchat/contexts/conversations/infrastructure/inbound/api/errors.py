...
from dizzchat.contexts.conversations.domain.message import InvalidMessageContent

_STATUS_BY_ERROR: dict[type[ConversationsError], int] = {
...
def register_conversations_error_handlers(app: FastAPI) -> None:
